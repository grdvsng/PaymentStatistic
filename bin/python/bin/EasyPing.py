...
class EasyPing:
    ...
    def ping(self, nodes, count=4, size=32, ttl=None, interval=4000, quick=False):
        ...
        else: self.last_result = self._printer(result) # Only printer     
    ...
    def __call__(self, nodes, count=4, size=32, ttl=None, interval=4000, quick=False):
        ''' Method __call__ class EasyPing.
            Return method ping.

        '''
        
        return self.ping(nodes, count=4, size=32, ttl=None, interval=4000, quick=False)